...
class Home extends React.Component{
    ...
    render(){
        ...
        <div className = 'home-container'>
            ...
            <h3 className="grey-text w-responsive text-center mx-auto mb-5">Shared living, made simple.</h3>
                    ...
                    <MDBCol>
                        <MDBRow className="home-content-top">
                            <MDBCol  md="8" size="10">
                                ...
                                <button className="createAccount" onClick={this.signIn}>Create a free account </button>
                            </MDBCol>
                        </MDBRow>
                    </MDBCol>
                </MDBRow>
            ...
            <main className = 'home-content'>
                    ...
                    <div className = 'about-tile-grid'>
                        <div className = 'about-tile'>
                            <div className = 'about-icon'>
                                <MDBIcon icon="users" size = '3x' className = 'light-blue-text'/></div>
                            <div className = 'about-text'>
                                <h3>Roommates? <br></br>Handled.</h3>
                                <p>Shared living means shared expenses, but keeping a tally can be a hassle. Keep track of everyone's contributions with MyShare.</p></div></div>
                        <div className = 'about-tile'>
                            <div className = 'about-icon'>
                                <MDBIcon icon="glass-cheers" size = '3x' className = 'purple-text'/></div>
                            <div className = 'about-text'>
                                <h3>Parties?<br></br>We can dig it.</h3>
                                <p>The more the merrier! Create shopping lists for events, dinner parties, and get-togethers with up to 6 members.</p></div></div>
                        <div className = 'about-tile'>
                            <div className = 'about-icon'>
                                <MDBIcon icon="utensils" size = '3x'className = 'amber-text'/></div>
                            <div className = 'about-text'>
                                <h3>Your pantry, <br></br>planned.</h3>
                                <p>Planning meals means getting the right ingredients. But who can keep track of them all? You, that's who.</p></div></div>
                    </div></section>                
                    ...
                    <div className = 'value-tile-grid'>
                        <div className = 'value-tile'>
                            <div className = 'value-icon'>
                                <MDBIcon icon="hand-holding-usd" size = '3x' className = 'green-text' /></div>
                        ...
                        <div className = 'value-tile'>
                            ...
                            <div className = 'value-text'>
                                ...
                                <p>Your shopping list stays with you wherever you go, so you never have to worry about forgetting an item.</p>
                            </div>
                        </div>
                        <div className = 'value-tile'>
                            <div className = 'value-icon'>
                                <MDBIcon icon="chart-pie" size = '3x' className = 'indigo-text'/></div>
                            <div className = 'value-text'>
                                <h3>All your trips, at a glance.</h3>
                                <p>Every shopping trip you complete is logged so you can monitor trends, record expenditures, and stay under budget.</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <footer>Created by Tsai Huang - © MyShare 2020</footer>
            </div>
        )
    }
}
